...
DATASET_ID = 'movie_review_analytics'
...
try:
    ...
    logdf = spark.read.csv(processed_log_reviews, schema=log_review_schema)
    moviedf = spark.read.csv(processed_movie_reviews, schema=movie_review_schema)
